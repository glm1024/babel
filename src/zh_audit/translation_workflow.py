...
def build_translation_system_prompt():
    return build_plain_translation_system_prompt(
        role_description="i18n properties files",
        candidate_requirement="candidate_translation must contain only the translated RHS text, never include the key.",
    )
...
def build_translation_review_system_prompt():
    return build_plain_translation_review_system_prompt(
        review_description="English i18n properties translations",
    )
