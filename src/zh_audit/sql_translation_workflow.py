...
SQL_TRANSLATION_EVENT_HISTORY_LIMIT = 1000
...
class SqlTranslationSession(object):
    ...
    def _append_update_sql_once(self, item):
        ...
        rendered = _build_update_sql(item) + "\n"
    ...
    def _push_event(self, label, item, detail):
        ...
        del self.events[SQL_TRANSLATION_EVENT_HISTORY_LIMIT:]
...
def build_sql_translation_user_prompt(
    ...
    return build_plain_translation_user_prompt(
        payload={
            "source_text": source_text,
            "target_text": target_text,
            "target_missing": bool(target_missing),
...
def build_sql_translation_system_prompt():
    return build_plain_translation_system_prompt(
        role_description="SQL seed data",
        candidate_requirement="candidate_translation must contain only the translated English field text, never return SQL.",
    )
...
def build_sql_translation_review_user_prompt(
    ...
    return build_plain_translation_review_user_prompt(
        payload={
            "source_text": source_text,
            "candidate_text": candidate_text,
            "target_missing": bool(target_missing),
...
def build_sql_translation_review_system_prompt():
    return build_plain_translation_review_system_prompt(
        review_description="English SQL seed translations",
    )
